...
@dataclass
class GPTConfig:
    block_size: int = 1024 #this is the blocksize in tokens, not characters. It is used to specify the positional embeddings as torch.nn.Embedding(block_size, n_embd)
